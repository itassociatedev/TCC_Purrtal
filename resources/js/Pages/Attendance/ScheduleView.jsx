...
export default function ScheduleView() {
    ...
    return (
        <SidebarLayout
            ...
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Schedule View</h2>}
        >
            <div className="rounded-lg bg-white p-6 shadow-sm">
                <h3 className="text-lg font-bold text-gray-800">Master Schedule</h3>
                <p className="mt-2 text-gray-600">The grid showing all active employee shifts will go here.</p>
            </div>
        </SidebarLayout>
    );
}