                                                            ...
                                                            {week.map(day => {
                                                                ...
                                                                if (day.isOutOfBounds) {
                                                                    return (
                                                                        <td key={day.dateString} className="px-1 py-1.5 align-middle border-l border-gray-100">
                                                                            <div className="min-h-[80px] w-full rounded-lg border border-dashed border-gray-200 bg-gray-50"></div>
                                                                        </td>
                                                                    );
                                                                }
                                                                ...
                                                                return (
                                                                    <td key={day.dateString} className={`px-1 py-1.5 align-middle border-l border-gray-100 ${isCutoff ? 'bg-indigo-50/40' : ''}`}>
                                                                        ...
                                                                        >
                                                                            {/* 🟢 FIXED: Include abbreviated month next to numerical day. */}
                                                                            <div className="absolute top-1 left-2 text-[10px] font-bold text-gray-400">
                                                                                {new Date(`${day.dateString}T00:00:00`).toLocaleDateString('en-US', { month: 'short' })}-{day.dateString.split('-')[2]}
                                                                            </div>
