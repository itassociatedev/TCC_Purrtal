...
export default function SetupSchedule() {
    ...
    return (
        <SidebarLayout
            ...
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Set Up Employee Schedule</h2>}
        >
            <div className="rounded-lg bg-white p-6 shadow-sm">
                <h3 className="text-lg font-bold text-gray-800">Schedule Configuration</h3>
                <p className="mt-2 text-gray-600">This is where you will build the shift assignment interface.</p>
            </div>
        </SidebarLayout>
    );
}