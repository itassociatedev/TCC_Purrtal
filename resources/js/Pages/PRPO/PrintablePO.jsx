...
export default function PrintablePO({ pos = [] }) {
    ...
    return (
        <div className="min-h-screen bg-gray-200 print:bg-white py-8 print:py-0 font-sans">
            <Head title={`Purchase Orders Batch`} />
            <style>
                {`
                    @media print {
                        @page {
            ...
            <div className="max-w-5xl mx-auto mb-4 flex justify-between items-center print:hidden px-4">
                ...
                >
                    Print All Purchase Orders / Save as PDF
                </button>
            </div>
            ...
            {pos.map((po) => {
                ...
                return (
                    <div key={po.id} className="page-break-wrapper mb-8 print:mb-0">
                        {}
                                ...
                                <table className="w-full text-[10px] text-left mb-2 border-collapse">
                                    <thead className="bg-gray-100 border-y border-gray-300">
                                        <tr>
                                            ...
                                            <th className="py-[3px] px-2 font-bold text-gray-800 text-right w-[15%]">Old Unit Price</th>
